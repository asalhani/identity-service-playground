    ...
    public class ConsentController : Controller
    {
        ...
        public async Task<IActionResult> Index(string returnUrl)
        {
            ...
            if (vm != null)
            {
                ...
                //automatically persist grants
                return await Index(new ConsentInputModel()
                {
                    Button = "yes",
                    RememberConsent = true,
                    ReturnUrl = vm.ReturnUrl,
                    ScopesConsented = vm.IdentityScopes.Select(x => x.Name).Union(vm.ResourceScopes.Select(y => y.Name).ToArray()).ToArray()
                });
            }
