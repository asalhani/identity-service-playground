    ...
    public partial class Application : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserMessageType", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.RoleId,
                        principalSchema: "IdentityService",
            ...
            migrationBuilder.CreateTable(
                name: "AspNetPasswordHistory",
                schema: "IdentityService",
                columns: table => new
                {
                    AspNetPasswordHistoryId = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetPasswordHistory", x => x.AspNetPasswordHistoryId);
                    table.ForeignKey(
                        name: "FK_AspNetPasswordHistory_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalSchema: "IdentityService",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetPasswordHistory_UserId",
                schema: "IdentityService",
                table: "AspNetPasswordHistory",
                column: "UserId");
