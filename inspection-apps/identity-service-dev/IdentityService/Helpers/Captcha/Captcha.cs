...
namespace IdentityService.Helpers
{
    public static class Captcha
    {
        ...
        public static string GenerateCaptchaCode(string letters, int CharacterCount=4)
        {
        ...
        {
            return $"{Path.GetRandomFileName()}{Path.GetRandomFileName()}".Replace(".",string.Empty);
        }

        public static CaptchaResultOutput GenerateCaptchaImage(int width, int height, string captchaCode, string fontFamilyName="Verdana")
        {
            ...
            using (Graphics graph = Graphics.FromImage(baseMap))
            {
                ...
                return new CaptchaResultOutput { CaptchaCode = captchaCode, CaptchaByteData = ms.ToArray(), Timestamp = DateTime.Now };
                ...
                void DrawCaptchaCode()
                {
                    ...
                    Font font = new Font(fontFamilyName, fontSize, FontStyle.Bold, GraphicsUnit.Pixel);                    
